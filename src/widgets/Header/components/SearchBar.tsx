  ...
  (
    ...
    const followedTeamMap = useMemo(() => {
      return allTeams.reduce<Record<string, boolean>>((acc, team) => {
        ...
        const nameKey = String(team.name ?? '')
          .trim()
          .toLowerCase();
    ...
    const isTeamFollowed = useCallback(
                ...
                (() => {
                  ...
                  return (
                    <Button
                      ...
                      onClick={(event) => {
                        void handleTeamFollowToggle(event, result);
                      }}
                      sx={{
                        minWidth: 86,
                        borderRadius: 999,
    ...
    const renderDetail = () => {
      ...
      const providerTeamId =
        typeof meta.providerTeamId === 'string' || typeof meta.providerTeamId === 'number'
